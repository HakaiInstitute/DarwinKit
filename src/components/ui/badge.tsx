...
const sizes = {
  xs: "text-xs/5 font-normal sm:text-xs/5",
  sm: "text-sm/5 font-normal sm:text-sm/5",
  md: "text-md/5 font-medium sm:text-md/5",
  lg: "text-lg/5 font-semibold sm:text-lg/5",
};
