...
interface ConfigurationMachineContext {
  projectId: string;
  ...
  transformations: Record<string, { strategy: string; parameters: Record<string, unknown> }>;
  ...
  validations: Record<string, { validation: string; parameters: Record<string, unknown> }>;
...
interface ConfigurationMachineInput {
  projectId: string;
}
