...
import { getCanonicalTerms, getVocabularyTerms, findCanonicalTerm } from "./vocabulary-service";
...
export interface ValidationFunction<T = any> {
  ...
  validate: (value: any, parameters: T) => ValidationResult | Promise<ValidationResult>;
}

// Helper to create successful validation result
const success = (): ValidationResult => ({ isValid: true, errors: [], warnings: [] });
...
export const validateControlledVocabulary: ValidationFunction<z.infer<typeof parameterSchemas.validateControlledVocabulary>> = {
...
export const validateCoordinateRange: ValidationFunction<z.infer<typeof parameterSchemas.validateCoordinateRange>> = {
...
export const validateDateRange: ValidationFunction<z.infer<typeof parameterSchemas.validateDateRange>> = {
...
export const validateRequired: ValidationFunction<z.infer<typeof parameterSchemas.validateRequired>> = {
