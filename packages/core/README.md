...
This package implements the data processing pipeline using DuckDB for CSV operations. It provides the `Workspace` API for loading, validating, and transforming datasets. It's intended to be consumed by other packages, like [@dwkt/cli](../cli/README.md).
