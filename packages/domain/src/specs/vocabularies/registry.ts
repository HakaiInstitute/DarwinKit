...
/**
 * Vocabulary metadata for documentation and validation
 */
export const VOCABULARY_METADATA = {
  ...
  taxonRank: {
    label: "Taxon Rank",
    description: "The taxonomic rank of the most specific name",
    source: "Darwin Core",
    caseSensitive: false,
  },
  occurrenceStatus: {
    label: "Occurrence Status",
    description: "A statement about the presence or absence of a taxon",
    source: "Darwin Core",
    caseSensitive: false,
  },
  lifeStage: {
    label: "Life Stage",
    description: "The age class or life stage of the organism",
    source: "Darwin Core",
    caseSensitive: false,
  },
  sex: {
    label: "Sex",
    description: "The sex of the biological individual",
    source: "Darwin Core",
    caseSensitive: false,
  },
  establishmentMeans: {
    label: "Establishment Means",
    description: "Statement about whether an organism is native or introduced",
    source: "Darwin Core",
    caseSensitive: false,
  },
  countryCode: {
  ...
  typeStatus: {
    label: "Type Status",
    description: "Nomenclatural type designation for the specimen",
    source: "Darwin Core",
    caseSensitive: false,
  },
} as const;
